...
$(MODULE_CACHE_PATH)/lib.so: PRIVATE_CFLAGS := $(LOCAL_CFLAGS)
$(MODULE_CACHE_PATH)/lib.so: PRIVATE_CPPFLAGS := $(LOCAL_CPPFLAGS)
...
$(MODULE_CACHE_PATH)/lib.so: $(__BUILT_MODULE)
	...
	$$(hide) cp $$(PRIVATE_BUILT_MODULE) $$(PRIVATE_MODULE_CACHE_PATH)/lib.so
	$$(hide) cp $$(PRIVATE_LINKED_MODULE) $$(PRIVATE_MODULE_CACHE_PATH)/symbols.so
	$$(hide) vendor/cm/tools/shlib-cache-enter \
		"$$(PRIVATE_MODULE_CACHE_PATH)" \
		"$$(PRIVATE_LOCAL_PATH)" \
		"$$(PRIVATE_INTERMEDIATES_PATH)" \
