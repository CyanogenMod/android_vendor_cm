...
function oat2dex() {
    ...
    get_file "system/framework/arm64/boot.oat" "$TMPDIR/boot_arm64.oat" "$SRC" "true" && ARCHES+="arm64 "
    get_file "system/framework/arm/boot.oat" "$TMPDIR/boot_arm.oat" "$SRC" "true" && ARCHES+="arm "
