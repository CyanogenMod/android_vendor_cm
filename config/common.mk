...
ifeq ($(CM_BUILDTYPE), RELEASE)
    ...
    ifeq ($(PRODUCT_VERSION_MINOR),0)
        ifneq ($(TARGET_UNOFFICIAL_RELEASE_ID),)
            CM_VERSION := $(PRODUCT_VERSION_MAJOR)-$(TARGET_UNOFFICIAL_RELEASE_ID)-$(CM_BUILDTYPE)$(CM_EXTRAVERSION)-$(CM_BUILD)
        else
            CM_VERSION := $(PRODUCT_VERSION_MAJOR)-$(shell date -u +%Y%m%d)-$(CM_BUILDTYPE)$(CM_EXTRAVERSION)-$(CM_BUILD)
        endif
    else
        ifneq ($(TARGET_UNOFFICIAL_RELEASE_ID),)
            CM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(TARGET_UNOFFICIAL_RELEASE_ID)-$(CM_BUILDTYPE)$(CM_EXTRAVERSION)-$(CM_BUILD)
        else
