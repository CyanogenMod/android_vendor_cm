...
ifdef CM_NIGHTLY
    ...
    ifdef CM_SNAPSHOT
        ...
        ifdef CM_RELEASE
            ...
            CM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)-$(CM_BUILD)-$(shell date +%Y%m%d)-UNOFFICIAL
        endif
    endif
endif
