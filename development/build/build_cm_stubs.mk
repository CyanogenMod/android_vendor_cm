# Build an SDK jar file out of the generated cm stubs
# Input variable:
...
cm_framework_res_package := $(call intermediates-dir-for,APPS,org.cyanogenmod.platform-res,,COMMON)/package-export.apk
...
$(full_target): PRIVATE_FRAMEWORK_RES_PACKAGE := $(cm_framework_res_package)
