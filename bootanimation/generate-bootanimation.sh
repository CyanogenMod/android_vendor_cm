...
echo "****************************************************"
echo "The boot animation could not be generated as"
echo "ImageMagick is not installed in your system."
echo ""
echo "Please install ImageMagick from this website:"
echo "https://imagemagick.org/script/binary-releases.php"
echo "****************************************************"
exit
fi
